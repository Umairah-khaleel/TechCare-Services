...
public class ACRepairActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivMenu.setOnClickListener(v -> {
            PopupMenu popup = new PopupMenu(ACRepairActivity.this, ivMenu);
    ...
    private void submitBooking() {
        ...
        if (deviceModel.isEmpty()) { editTextDeviceModel.setError("Enter AC model"); return; }
        ...
        booking.put("serviceType", "AC Repair");
        ...
        db.collection("bookings").add(booking)
                .addOnSuccessListener(doc -> {
                    Toast.makeText(this, "AC Repair request submitted!", Toast.LENGTH_LONG).show();
                    finish();
                })
