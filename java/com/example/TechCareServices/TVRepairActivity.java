...
public class TVRepairActivity extends AppCompatActivity {

    // ivMenu for the Dropdown trigger
    private View ivMenu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Logic: Show address ONLY for Home Pickup (Position 1)
        ...
        ivMenu.setOnClickListener(v -> {
            PopupMenu popup = new PopupMenu(TVRepairActivity.this, ivMenu);
    ...
    private void submitBooking() {
        ...
        if (deviceModel.isEmpty()) {
            editTextDeviceModel.setError("Enter TV model");
            return;
        }
        ...
        if (serviceMethod.equals("Home Pickup") && address.isEmpty()) {
            editTextAddress.setError("Address is required for pickup");
            return;
        }
        ...
        booking.put("serviceType", "TV Repair");
        booking.put("serviceMethod", serviceMethod);

        // ✅ ONLY EDITED PART: Store null if Drop-off
